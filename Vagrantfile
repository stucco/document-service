...
Vagrant.configure("2") do |config|
  ...
  # Shared folder
  config.vm.synced_folder ".", "/document-service"
  ...
  if Dir.glob("#{File.dirname(__FILE__)}/.vagrant/machines/default/*/id").empty?
    ...
    # @see http://docs.docker.io/en/latest/use/basics/#why-sudo
    pkg_cmd << "sudo groupadd docker; sudo gpasswd -a vagrant docker;"
